...
could not run a random forest using this much data.  I set the K-fold cross-validation to 5 in the train
 function, and ran the model.  Using the confusion matrix function, I arrived at the statistics  listed 
 below.  The accuracy level of 99% was far more than what I achieved using a simple decision tree.
